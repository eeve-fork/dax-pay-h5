...
import type { MchBaseProfile, MchSettleParam, MchSettleResult } from './MerchantProfile.api'
...
// 原始表单数据，用于取消时恢复
const originalFormData = ref<MchSettleResult>({} as any)

// 基础信息(商户类型等)
const baseProfile = ref<MchBaseProfile>({} as any)

// 表单数据
const form = ref<MchSettleResult>({
  bankCard: {},
  cardHolder: {},
})
